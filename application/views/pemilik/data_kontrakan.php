	...
	<?php echo $this->session->flashdata('success'); ?>
		...
		foreach($kontrakan as $krn): ?>
			...
			<tr>
				...
				<td><?php echo $krn->nama_pemilik ?></td>
				<td><?php echo $krn->status_kontrakan ?></td>
				<td><?php echo anchor('pemilik_kontrakan/data_kontrakan/edit/'.$krn->id_krn,'<div class="btn btn-success btn-sm"><i class="fas fa-fw  fa-edit"></i></div>') ?></td>
				<td><?php echo anchor('pemilik_kontrakan/data_kontrakan/hapus/'.$krn->id_krn,'<div class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash"></i></div>') ?></td>
			</tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
			<form action="<?php echo base_url().'pemilik_kontrakan/data_kontrakan/tambah_aksi'; ?>" method="post" enctype="multipart/form-data">
